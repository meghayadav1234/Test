...
public class VendingMachineOperations2 implements VendingMachineOperationsInterface {
	
	private final static Logger logger = LogManager.getLogger(VendingMachineOperations2.class);
